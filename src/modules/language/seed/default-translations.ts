export const defaultLanguages: {
    ...
    { code: 'de', name: 'German', nativeName: 'Deutsch', active: false, isDefault: false, fallbackCode: 'en' },
    { code: 'sq', name: 'Albanian', nativeName: 'Shqip', active: false, isDefault: false, fallbackCode: 'en' },
    { code: 'sw', name: 'Swahili', nativeName: 'Kiswahili', active: false, isDefault: false, fallbackCode: 'en' },
];
